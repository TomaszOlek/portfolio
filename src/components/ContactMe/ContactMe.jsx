    ...
    <Container id="contact">
      <Clip>
        ...
        <div>
          ...
          >
            <Link
              href="https://www.linkedin.com/in/tomasz-olek-383b57241/"
              target="_blank"
            >
              <Icon
                icon="uil:linkedin"
            ...
            <Link href="https://github.com/TomaszOlek" target="_blank">
              <Icon
                icon="mdi:github"
                className="icon"
                style={{ position: "absolute", width: "35px", height: "35px" }}
            ...
            <Link href="https://codepen.io/TomaszOlek" target="_blank">
              <Icon
