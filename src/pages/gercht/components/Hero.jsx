  ...
  return (
    <Container id="home">
      <div style={{position:"absolute", width:"0"}} className="gs_reveal">
        <SideText><Paragraf color="#FFFFFF">#Bar_Gericht</Paragraf></SideText>
      </div>
      <Content className="gs_reveal">
        <div style={{width:"453px", height:"481px"}}>
          ...
          <CustomText 
            ...
            spacing="0.03em" 
            color="#DCCA87"
          >The key to Fine dining</CustomText>
          <Paragraf margin="25px 0px 25px 0">Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus</Paragraf>
