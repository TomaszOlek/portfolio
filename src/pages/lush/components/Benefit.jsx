      ...
      <Contnent>
        <Benefits>
          <img
            ...
            alt="Time cosuming"
            loading="lazy"
            style={{ maxWidth: "126px", maxHeight: "126px" }}
            className="gs_reveal"
          />
          <CustomText
            align="left"
        ...
        <Benefits backgroundColor="#F8F8F8">
          ...
          <CustomText
            ...
            className="gs_reveal"
          >
            Our flowers are always fresh, handpicked and delivered promptly for
        ...
        <Benefits backgroundColor="#F8F8F8">
          ...
          <CustomText
            ...
            className="gs_reveal"
          >
            We work smart, using innovative techniques and technology to
        ...
        <Benefits>
          ...
          <CustomText
            ...
            className="gs_reveal"
          >
            We pride ourselves on providing excellent service, going above and
