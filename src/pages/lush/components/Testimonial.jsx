    ...
    <Container>
      ...
      <div style={{ display: "flex", flexDirection: "row", gap: "70px" }}>
        <Box className="gs_reveal">
          ...
          <CustomText align="left" color="#121212">
          ...
          <div style={{ position: "relative" }}>
            <img
              src={BackgroundPlant1}
              alt="background plant"
              loading="lazy"
              style={{ position: "absolute", left: "65px", bottom: "-52px" }}
            />
          </div>
        </Box>
        <Box className="gs_reveal">
          ...
          <div style={{ position: "relative" }}>
            <img
              src={BackgroundPlant2}
              alt="background plant"
              loading="lazy"
              style={{ position: "absolute", left: "145px", bottom: "-109px" }}
            />
          </div>
        </Box>
        <Box className="gs_reveal">
          ...
          <CustomText align="left" color="#121212">
            "I am very happy with my purchase from this website, the plants were
            healthy and arrived on time.”
          </CustomText>
          <div style={{ position: "relative" }}>
            <img
              src={BackgroundPlant3}
              alt="background plant"
              loading="lazy"
              style={{ position: "absolute", left: "125px", bottom: "-81px" }}
            />
          </div>
        </Box>
      </div>
